...
const day1Events = [
  ...
  { time: "11-1 PM", title: "Aaghaz", description: "A mesmerizing opening performance." , image: "/event-poster.png"},
  { time: "11-1 PM", title: "Alaap", description: "Soulful musical experience.", image: "/event-poster.png" },
  
];

const day1EventsPart2 = [
  { time: "11-1 PM", title: "Jashn E Alfaz", description: "Poetry and spoken word magic.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Kaun Banega Bollywood Pati", description: "A fun Bollywood-themed game show." , image: "/event-poster.png"},
  { time: "11-1 PM", title: "Singer Performance", description: "Live vocal performance.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Bollywood Masquerade", description: "A grand masquerade ball.", image: "/event-poster.png" },
];

const day2Events = [
  { time: "11-1 PM", title: "Lilac Dreams", description: "A dreamy stage performance.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Lyrical Showdown / Rap Battle", description: "Rap battles with intense wordplay.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Antra / Group Singing", description: "Soulful melodies from groups.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Rang Manch / Solo Acting", description: "Drama and expressions on stage.", image: "/event-poster.png" },
  
];

const day2EventsPart2 = [
  { time: "11-1 PM", title: "Solo Dance Competition", description: "Incredible solo dance performances.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Artist Performance", description: "A spectacular artist showcase.", image: "/event-poster.png" },
  { time: "11-1 PM", title: "Surprise Event", description: "A surprise entertainment segment.", image: "/event-poster.png" },
];
